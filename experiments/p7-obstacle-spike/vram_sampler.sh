#!/usr/bin/env bash
# p7c1 W0 spike — VRAM sampler. THROWAWAY (experiments/**).
#
# COPIED VERBATIM from experiments/p6-granularity-spike/vram_sampler.sh (branch
# exp/p6-granularity-spike) — the recipe below is profiles/rtx_4080.yaml's adoption
# block, and copying it unchanged is what makes p6 and p7 VRAM series comparable.
#
